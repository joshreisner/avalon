...
@section('main')
	{{ Form::open('login/users/' . $user->id, 'PUT', array('class'=>'form-horizontal user')) }}
		<div class="control-group">
			<label class="control-label" for="firstname">First Name</label>
			<div class="controls">
				<input type="text" name="firstname" value="{{ $user->firstname }}" class="required span5">
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" name="lastname" value="{{ $user->lastname }}" class="required span5">
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" name="email" value="{{ $user->email }}" class="required email span5">
			</div>
		</div>
