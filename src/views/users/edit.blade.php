...
@section('main')
	...
	<div class="form-group">
		{{ Form::label('firstname', Lang::get('avalon::messages.users_firstname'), array('class'=>'col-sm-2')) }}
	    <div class="col-sm-10">
	...
	<div class="form-group">
		{{ Form::label('lastname', Lang::get('avalon::messages.users_lastname'), array('class'=>'col-sm-2')) }}
	    <div class="col-sm-10">
	...
	<div class="form-group">
		{{ Form::label('email', Lang::get('avalon::messages.users_email'), array('class'=>'col-sm-2')) }}
	    <div class="col-sm-10">
	...
	<div class="form-group">
		{{ Form::label('role', Lang::get('avalon::messages.users_role'), array('class'=>'col-sm-2')) }}
	    <div class="col-sm-10">
